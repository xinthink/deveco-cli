...
export const SignatureResponseSignals = {
  ...
  /** 场景 1：statusCode=403 时 reason phrase 精确匹配此串 */
  OPENPROXY_BLOCKED_URL: 'Openproxy_Blocked_URL_list',

  /** 场景 4：响应体含此 ret.code 表示证书数量上限 */
...
export const SIGN_ERROR_MESSAGES = {
  ERROR_WHILE_ADD_DEVICE: 'Failed to add the device, please try again.',
  DEVICE_LIMIT_REACHED:
    'Device limit reached. Delete some unused devices and try again.',
